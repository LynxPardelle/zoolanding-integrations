...
def _runtime_dependencies():
    try:
        from runtime import subscription_migration_status_runtime
    except ModuleNotFoundError:
        from src.runtime import subscription_migration_status_runtime
    return subscription_migration_status_runtime()
